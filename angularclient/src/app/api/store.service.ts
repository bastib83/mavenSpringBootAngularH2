...
export class StoreService {
    ...
    protected basePath = 'https://virtserver.swaggerhub.com/Bastian-83/Pizzastore/1.0.0';
    ...
    public deleteOrder(orderId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/order/${encodeURIComponent(String(orderId))}`,
            {
     ...
     * @param orderId ID of pizza that needs to be fetched
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOrders(observe?: 'body', reportProgress?: boolean): Observable<Order>;
    public getOrders(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Order>>;
    public getOrders(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Order>>;
    public getOrders(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Order>(`${this.basePath}/orders`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * 
     * @param body order placed for purchasing the pizza
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
